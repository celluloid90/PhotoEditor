...
public class CollageHome extends AppCompatActivity implements FilePickerFragment.OnFilePickerItemClickListener, View.OnClickListener {
    ...
    public void onFilePickerItemClicked(List<MediaFile> mediaFiles) {
        Log.d("galleryItems", mediaFiles.size() + "");
    }
