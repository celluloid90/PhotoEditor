...
public class BlurImage {
    ...
    private static final String TAG = BlurImage.class.getSimpleName();
    /**
    ...
    public static Bitmap blur(Context context, Bitmap sentBitmap, int radius) {
        ...
        if (radius < 0) {
            radius = 0;
            if (DEBUG) {
                Log.d(TAG, "radius must be 0 < r < 25 , forcing radius=0");
            }
        } else if (radius > 25) {
            radius = 25;
            if (DEBUG) {
                Log.d(TAG, "radius must be 0 < r < 25 , forcing radius=25");
            }
        }
