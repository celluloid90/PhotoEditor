//
// Created by dev-lock on ১১/৫/২৩.
//

#ifndef BGREMOVER_COLORUTILS_H
#define BGREMOVER_COLORUTILS_H
...
//        }
    ...
    static float getColorDeltaE2000(rgbColor c1, rgbColor c2);
